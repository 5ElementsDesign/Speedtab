...
&lt;/div&gt;</pre>
          ...
          <div data-tab="visual" data-st-padding="20px" data-spaceless data-swipe-ignore>
            ...
            <div data-st-bg-color="rgba(255,255,255,0.03)" data-st-padding="16px" data-st-border-radius="8px" data-st-border-left="4px solid #22c55e">
              <b><span class="mirror mr-1" data-st-font-size="1.1rem">💪</span> Pro Tip:</b> You can use CSS custom properties (variables) like <code>var(--yai-tabs-color-accent)</code> or <code>var(--yai-tabs-color-secondary)</code> as values!
            </div>
          </div>
