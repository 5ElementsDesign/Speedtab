    ...
    constructor(customConfig = {}) {
        ...
        const tabsConfig = {
            ...
            events: {
                ...
                actionableAttributes: ['data-tab-action', 'data-swipe'],  // data-click auto-generated by YaiCore
                actionableClasses: [],
                actionableTags: [],
            },
    ...
    openTab(target, event, container, isDefaultInitialization = false) {
        ...
        try {
            ...
            if (target.classList.contains('active') && content.classList.contains('active')) {
                ...
                this.yaiEmit('tabReady', {container, target, content, context: this, id: tabId, refPath: container.dataset.refPath, isVisible: this.isElementVisible(container), isDefaultInit: isDefaultInitialization, });
            }
