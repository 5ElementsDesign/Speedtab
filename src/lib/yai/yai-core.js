...
class YaiCore {
    ...
    createEventHandler(selectors, aliases, options = {}) {
        ...
        if (this.config.autoActionableAttributes === undefined || this.config.autoActionableAttributes === true) {
    ...
    updateHash(container = null, forceReplace = false) {
        ...
        if (newHash !== window.location.hash.slice(1)) {
            ...
            this._executeHook('locationHashUpdated', {newHash, container, context: this});
